...
abstract class _Paths {
  ...
  static const CREATEFLAT = '/create-flat';
  static const RENTASSIGN = '/rent-assign';
  static const RENTASSIGNCONFIRM = '/rent-assign-confirm';
  static const RENTANDRENTOWNERCHAT = '/rent-rentOwner-chat';
  static const ADMINDASHBOARD = '/admin-dashboard';
  static const ADMINPLAYROLE = '/admin-play_role';
  static const ADMINFLATNO = '/admin-flat_no';
  static const ADMINFLATTYPE = '/admin-flat_type';
  static const ADMINPFLATSIZE = '/admin-flat_size';
