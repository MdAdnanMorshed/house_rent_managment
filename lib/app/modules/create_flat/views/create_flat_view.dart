      ...
      builder: ((context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          for (var doc in snapshot.data!.docs) {
            flatNoModel.add(FlatNoModel.fromJson(doc.data() as Map<String, dynamic>));
          }
    ...
    return StreamBuilder(
      ...
      builder: ((context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          for (var doc in snapshot.data!.docs) {
            flatFloorModel.add(FlatFloorModel.fromJson(doc.data() as Map<String, dynamic>));
          }
    ...
    return StreamBuilder(
      ...
      builder: ((context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          for (var doc in snapshot.data!.docs) {
            flatSize.add(FlatSizeModel.fromJson(doc.data() as Map<String, dynamic>));
          }
                ...
                return Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton2<String>(
                      ...
                      items: _.flatSizeList.map<DropdownMenuItem<String>>((value) {
                        return DropdownMenuItem<String>(
                      ...
                      onChanged: (String? newValue) {
                        print('CreateFlatView._selectFlatSizDropDown $newValue');
